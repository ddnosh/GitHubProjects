...
[YiZhi](https://github.com/Horrarndoo/YiZhi) | MVP+RxJava2+Retrofit2+Glide+Rxbus，主要实现日报、新闻、干货、影视等资讯，个人项目 | ![GitHub stars](https://img.shields.io/github/stars/Horrarndoo/YiZhi.svg)
[GeekNews](https://github.com/codeestX/GeekNews) | 📚A pure reading App based on Material Design + MVP + RxJava2 + Retrofit + Dagger2 + Realm + Glide | ![GitHub stars](https://img.shields.io/github/stars/codeestX/GeekNews.svg)
[WeiBo](https://github.com/wenmingvs/WeiBo) | 第三方新浪微博客户端 | ![GitHub stars](https://img.shields.io/github/stars/wenmingvs/WeiBo.svg)
[bilibili-android-client](https://github.com/HotBitmapGG/bilibili-android-client) | An unofficial bilibili client for android | ![GitHub stars](https://img.shields.io/github/stars/HotBitmapGG/bilibili-android-client.svg)
[remusic](https://github.com/aa112901/remusic) | 仿网易云音乐 安卓版，netease android，音乐播放器 在线 下载 | ![GitHub stars](https://img.shields.io/github/stars/aa112901/remusic.svg)
[NewPipe](https://github.com/TeamNewPipe/NewPipe) | A libre lightweight streaming front-end for Android. | ![GitHub stars](https://img.shields.io/github/stars/TeamNewPipe/NewPipe.svg)
[LQRWeChat](https://github.com/GitLqr/LQRWeChat) |  | ![GitHub stars](https://img.shields.io/github/stars/GitLqr/LQRWeChat.svg)
[MovieGuide](https://github.com/esoxjem/MovieGuide) | Movie discovery app showcasing MVP, RxJava, Dagger 2 and Clean Architecture | ![GitHub stars](https://img.shields.io/github/stars/esoxjem/MovieGuide.svg)
[lcg](https://github.com/fabricezhang/lcg) | 吾爱破解第三方安卓应用 | ![GitHub stars](https://img.shields.io/github/stars/fabricezhang/lcg.svg)
[BookReader](https://github.com/smuyyh/BookReader) | :closed_book: "任阅" 网络小说阅读器，3D翻页效果、txt/pdf/epub书籍阅读、Wifi传书~ | ![GitHub stars](https://img.shields.io/github/stars/smuyyh/BookReader.svg)
[reader-android](https://github.com/yuenov/reader-android) |  | ![GitHub stars](https://img.shields.io/github/stars/yuenov/reader-android.svg)
[ExoPlayer](https://github.com/google/ExoPlayer) | ExoPlayer is an application level media player for Android. It provides an alternative to Android’s MediaPlayer API for playing audio and video both locally and over the Internet. ExoPlayer supports features not currently supported by Android’s MediaPlayer API, including DASH and SmoothStreaming adaptive playbacks. Unlike the MediaPlayer API, ExoPlayer is easy to customize and extend, and can be updated through Play Store application updates. | ![GitHub stars](https://img.shields.io/github/stars/google/ExoPlayer.svg)
[Now](https://github.com/XunMengWinter/Now) | Jsoup + MaterialViewPager + RxJava2 + Retrofit + Lifecycle + Realm + Fresco + Retrolambda example 一款Android图文精选app，通过抓取网页获得图文列表。目前包含猫弄（MONO）早午茶、站酷（Zcool）精选、国家地理（National Geographic）每日一图、知乎日报、豆瓣一刻（Moment）。 | ![GitHub stars](https://img.shields.io/github/stars/XunMengWinter/Now.svg)
...
[mina-gulp-cli](https://github.com/milobluebell/mina-gulp-cli) | 一个轻量级的小程序开发脚手架，基于gulp | ![GitHub stars](https://img.shields.io/github/stars/milobluebell/mina-gulp-cli.svg)
